...
python -m hybrid_vtg.cli run --benchmark omtg --model timelens-8b --method native-128f --subset 100 --seed 42

# 2. Baseline: Random Temporal Crop (128f)
echo ""
echo ">>> [2/7] Running Baseline: Random Temporal Crop (128f)..."
python -m hybrid_vtg.cli run --benchmark omtg --model timelens-8b --method random-crop-128f --subset 100 --seed 42

# 3. Baseline: Oracle Ground-Truth Corridor (128f)
echo ""
echo ">>> [3/7] Running Baseline: Oracle Ground-Truth Corridor (128f)..."
python -m hybrid_vtg.cli run --benchmark omtg --model timelens-8b --method oracle-corridor-128f --subset 100 --seed 42

# 4. Ablation Step 1: Raw Cosine (128f)
echo ""
echo ">>> [4/7] Running Ablation Step 1: Raw Cosine Similarity..."
python -m hybrid_vtg.cli run --benchmark omtg --model timelens-8b --method sgde-step1-raw-cosine --subset 100 --seed 42

# 5. Ablation Step 2: + Z-Score Normalization (128f)
echo ""
echo ">>> [5/7] Running Ablation Step 2: + Z-Score Normalization..."
python -m hybrid_vtg.cli run --benchmark omtg --model timelens-8b --method sgde-step2-zscore --subset 100 --seed 42

# 6. Ablation Step 3: + Hysteresis & Energy Mining (128f)
echo ""
echo ">>> [6/7] Running Ablation Step 3: + Hysteresis & Energy Mining..."
python -m hybrid_vtg.cli run --benchmark omtg --model timelens-8b --method sgde-step3-energy --subset 100 --seed 42

# 7. Ablation Step 4: + Duration-Adaptive Geometry (128f, No Merge)
echo ""
echo ">>> [7/7] Running Ablation Step 4: + Duration-Adaptive Geometry..."
python -m hybrid_vtg.cli run --benchmark omtg --model timelens-8b --method sgde-step4-adaptive-geom --subset 100 --seed 42
