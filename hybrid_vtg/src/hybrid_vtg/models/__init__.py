...
def register_models(registry: Any) -> None:
    ...
    registry.register(
        "qwen3-vl-4b",
        lambda cache_dir, checkpoint=None, model_spec=None, feature_roots=(): QwenEvidenceBackend(
    ...
    registry.register(
        "univtg",
        lambda cache_dir, checkpoint=None, model_spec=None, feature_roots=(): UniVTGBackend(
