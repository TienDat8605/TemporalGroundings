...
def register_methods(registry: Any) -> None:
    ...
    def _make_sgde(frame_budget: int = 64, fallback_budget: int = 128):
    ...
    registry.register(SGDE64.name, _make_sgde(64, 128))
    registry.register("sgde-128", _make_sgde(128, 256))
